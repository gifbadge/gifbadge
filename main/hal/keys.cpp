...
void Keys::key_debounce_update(struct debounce_state *state,
                               const bool active,
...
bool Keys::key_debounce_is_active(const struct debounce_state *state) {
  return state->pressed || state->counter > 0;
}
bool Keys::key_debounce_is_pressed(const struct debounce_state *state) {
  return state->pressed;
}
bool Keys::key_debounce_get_changed(const struct debounce_state *state) {
