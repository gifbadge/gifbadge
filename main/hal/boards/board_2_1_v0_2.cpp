...
//    _i2c->write_reg(ESP_IO_EXPANDER_I2C_TCA9555_ADDRESS_000, 0x04, &data, 1);
  ...
  esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_3, IO_EXPANDER_OUTPUT);
  ...
  esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_14|IO_EXPANDER_PIN_NUM_12|IO_EXPANDER_PIN_NUM_13, IO_EXPANDER_INPUT);
  esp_io_expander_print_state(io_expander);
  _keys = std::make_shared<keys_esp_io_expander>(io_expander, 14, 12, 13);
